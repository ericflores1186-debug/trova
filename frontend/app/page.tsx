...
const HOW_IT_WORKS = [
  {
    icon: Clapperboard,
    title: "Paste a video",
    body: "Any YouTube travel video with captions turned on — a vlog, a hotel tour, a city guide.",
  },
  {
    icon: Wand2,
    title: "Trova listens",
    body: "It reads the transcript and pulls out every hotel, resort and stay you actually named.",
  },
  {
    icon: Hotel,
